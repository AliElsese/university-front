...
const LoginForm = () => {
  ...
  return (
    <motion.div
      ...
      className='max-w-full w-[700px] px-8 py-15 bg-[#171e2e26] dark:bg-gray-800 backdrop-blur text-dark border-b-3 border-[#3182ce] rounded shadow-lg relative'
    >
      <form
        onSubmit={handleSubmit}
        className='flex flex-col-reverse md:flex-row gap-5 items-center justify-between'
      >
        ...
        <img src={logo} alt="Tanta Universaty" className='w-30 h-30 rounded-full shadow' />
        <h2 className="text-4xl">Tanta University</h2>
        </div>
